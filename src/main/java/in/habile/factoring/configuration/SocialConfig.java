 ...
 */
package in.habile.factoring.configuration;
...
import in.habile.factoring.auth.SecurityContext;
import in.habile.factoring.auth.SimpleConnectionSignUp;
import in.habile.factoring.auth.SimpleSignInAdapter;
import in.habile.factoring.auth.User;
...
@ComponentScan({ "in.habile.factoring" })
...
public class SocialConfig {
	...
	public ConnectionFactoryLocator connectionFactoryLocator() {
		...
		System.out.println("google.clientId"+environment.getProperty("google.clientId"));
